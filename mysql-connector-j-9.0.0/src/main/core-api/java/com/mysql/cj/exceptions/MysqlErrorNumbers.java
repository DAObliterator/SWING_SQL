...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_REPLICA_THREAD = 1202; // [HY000] Could not create replica thread; check system main.resources
    ...
    public final static int ER_WARN_CANNOT_FREE_COMPONENT_DATA_DEALLOCATION_FAILED = 14015; // [HY000] Cannot free main.resources stored by component '%s' in thre...
    ...
    public final static int ER_MDL_OUT_OF_RESOURCES = 3985; // [HY000] Not enough main.resources to complete lock request.
